 ...
 * It's also immutable - we don't want the values to change for any instance of the card.
 */
public class Card
    ...
    /**
     * Implemented only because it's a good idea to do so when implementing equals (used with hash
     * type collections, HashMap, etc...)
     *
     * @return
     */
    @Override
